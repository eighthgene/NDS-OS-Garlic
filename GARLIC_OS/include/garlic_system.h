/*------------------------------------------------------------------------------
	...
	Programador P: oleg.sokolov@estudiants.urv.cat
	Programador M: yyy.yyy@estudiants.urv.cat
	Programador G: enyu.lin@estudiants.urv.cat
...
extern int _gd_mod;				// variable per guardar resta (mod)

extern int _gd_percentString;	// variable per guardar % worktics en string
